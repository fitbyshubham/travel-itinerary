...
export default function CreatePostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "UPLOAD_FAILED // TRY_AGAIN";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#050A15]/80 backdrop-blur-md border border-white/10 rounded-2xl p-5 md:p-6 space-y-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Globe
                    className={`w-4 h-4 ${visibility === "public" ? "text-neon-lime" : "opacity-50"}`}
                  />
                ...
                >
                  <Lock
                    className={`w-4 h-4 ${visibility === "draft" ? "text-white" : "opacity-50"}`}
                  />
